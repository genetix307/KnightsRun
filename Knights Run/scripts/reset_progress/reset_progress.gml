...
store.challenge_b=2
store.challenge_c=5
store.goal_mushroomslayer=0
store.lvl_mushroomslayer=1
...
store.goal_bloodthirst=0
store.lvl_bloodthirst=1
store.goal_healer=0
store.lvl_healer=1
store.goal_shopaholic=0
...
store.shiva_readytime=240
store.guardian_phoenix_lvl=0
